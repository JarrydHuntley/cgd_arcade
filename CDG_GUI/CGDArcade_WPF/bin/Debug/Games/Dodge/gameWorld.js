  ...
  window.GameWorld = (function() {
    ...
    GameWorld.prototype.swap = function(onbot) {
      ...
      if (!this.swapPeriod) {
        ...
        this.targetAngle1 = this.createTarget(this.levelOrder[0].angle, Math.PI / 2);
        this.targetAngle2 = this.createTarget(this.levelOrder[1].angle, -(Math.PI / 2));
    ...
    GameWorld.prototype.reverse = function(onbot) {
      ...
      if (!this.revPeriod) {
        ...
        this.targetAngle = this.createTarget(this.levelOrder[this.revTarget].angle, Math.PI);
    ...
    GameWorld.prototype.createTarget = function(old, adj) {
      var target;
    ...
    GameWorld.prototype.update = function() {
      ...
      if (!this.gameOver && !this.startGame) {
        ...
        if (!this.level1.gameOver) {
          if (!this.challengePrep) {
            this.level1.update(g.input.isKeyNewDown(83));
          }
        ...
        if (!this.level2.gameOver) {
          if (!this.challengePrep) {
            return this.level2.update(g.input.isKeyNewDown(76));
          }
        } else if (!this.gameOver) {
          this.end = g.now;
          this.gameOver = true;
